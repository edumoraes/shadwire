...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "card docs page renders examples and api" do
    ...
    assert_select "[data-slot='card-title']", text: "Create project"
    assert_select "[data-slot='card-footer'] button", text: "Create"
  ...
  test "avatar docs page renders examples and api" do
    ...
    assert_select "span[aria-label='Anonymous user'] span", text: "?"
  ...
  test "icon docs page renders examples and api" do
    ...
    assert_select "svg[role='img'][aria-label='Notifications']"
  ...
  test "accordion docs page shows live examples from the shadcn reference" do
    ...
    assert_select "[data-slot='accordion-trigger']", text: "How do I reset my password?"
  ...
  test "label docs page renders examples and api" do
    ...
    assert_select "label[for='label-demo-username'][data-slot='label']", text: "Username"
  ...
  test "radio group docs page renders examples and api" do
    ...
    assert_select "[role='radiogroup'][aria-label='Interface density']"
  ...
  test "table docs page renders examples and api" do
    ...
    assert_select "[data-slot='table-container'] table caption", text: /recent invoices/
  ...
  test "breadcrumb docs page renders examples and api" do
    ...
    assert_select "nav[aria-label='breadcrumb'] a[data-slot='breadcrumb-link']", text: "Home"
  ...
  test "tabs docs page renders examples and api" do
    ...
    assert_select "[role='tablist'] button[role='tab'][data-ui-tabs-value='password']", text: "Password"
  ...
  test "dialog docs page renders examples and api" do
    ...
    assert_select "[data-controller='ui-dialog'] button[aria-haspopup='dialog']", text: "Edit profile"
    assert_select "dialog[data-slot='dialog-content'] h2[data-slot='dialog-title']", text: "Edit profile"
  ...
  test "alert dialog docs page renders examples and api" do
    ...
    assert_select "dialog[role='alertdialog'] h2[data-slot='alert-dialog-title']", text: "Are you absolutely sure?"
    assert_select "[data-slot='alert-dialog-cancel']", text: "Cancel"
    assert_select "[data-slot='alert-dialog-action']", text: "Continue"
  ...
  test "sheet docs page renders examples and api" do
    ...
    assert_select "dialog[data-slot='sheet-content'][data-side='right'] h2[data-slot='sheet-title']", text: "Edit profile"
  ...
  test "popover docs page renders examples and api" do
    ...
    assert_select "[data-controller='ui-popover'] button[data-slot='popover-trigger']", text: "Open dimensions"
  ...
  test "select docs page renders examples and api" do
    ...
    assert_select "[role='listbox'] [role='group'] [data-slot='select-label']", text: "North America"
